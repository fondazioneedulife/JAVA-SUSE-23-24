...
public class storia{
    ...
    public static void main(String[] args) {
        ...
        ",\n non fece altro che deprimerlo ulteriormente, finendo per farlo diventare l'ennesima vittima\n del capitalismo moderno. Ah si, poi andò a comprarsi un panino dal kebabbaro e si sentì meno peggio\n";
