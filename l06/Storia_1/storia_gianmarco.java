...
public class storia_gianmarco {
    public static void main(String[] args) {
        ...
        String laMiaStoria= dettagli.getMainCharacter()  + dettagli.getWork() + ", scavava la terra, la \"Sirena d'Argento\". In lontananza, spuntò una nave pirata guidata dal temibile " + dettagli.getEnemy() + ". La battaglia fu feroce, ma con astuzia, Mic respinse l'assalto.\n" + //
